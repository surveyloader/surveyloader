	...
	var Index = (function (_React$Component) {
	  ...
	  _Index.prototype.componentDidMount = function componentDidMount() {
	    ...
	    _store2['default'].dispatch({
	      type: 'SET_ASPECTS',
	      aspects: Object.keys(this.props).filter(function (p) {
	        return /\$aspect\d+\$_text/.test(p);
	      }).map(function (p) {
	        return { text: _this2.props[p] };
	      })
	    });
	  };
	  ...
	  _createClass(_Index, null, [{
	    ...
	    value: {
	      ...
	      $aspect$$_text: _react.PropTypes.array.isRequired
	    },
	    enumerable: true
	  }, {
	    key: 'defaultProps',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _hashids = __webpack_require__(16);
	  ...
	  switch (action.type) {
	    ...
	    case 'SET_ASPECTS':
	      return _extends({}, state, {
	        aspects: action.aspects.map(function (a, i) {
	          return _extends({}, a, { index: i });
	        }),
