...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = (function (_React$Component) {
	  ...
	  _App.prototype.componentWillUpdate = function componentWillUpdate(nextProps, nextState) {
	    var aspects = this.props.aspects;
	    var lower = nextState.lower;
	    var upper = nextState.upper;
	    var choices = nextState.choices;

	    if (choices + 1 > this.props.n) {
	      var _props$push;

	      this.props.push((_props$push = {}, _props$push['pairwise_' + _globalServicesStringHash2['default'](aspects[0]) + '_' + _globalServicesStringHash2['default'](aspects[1]) + '_lower'] = lower, _props$push['pairwise_' + _globalServicesStringHash2['default'](aspects[0]) + '_' + _globalServicesStringHash2['default'](aspects[1]) + '_upper'] = upper, _props$push));
	    }
	  };
